...
# this runs the Naive Bayes 20 times and then sees the accuracy of each split.
AccuracyScores =[]
for i in range(20):
    random.shuffle(documents)
    ...
    AccuracyScores.append(nltk.classify.accuracy(classifier, TestingSet))
    print(AccuracyScores[i])
