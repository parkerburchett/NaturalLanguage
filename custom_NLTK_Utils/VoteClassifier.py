...
class VoteClassifier(ClassifierI):
    ...
    def _vectorize(self, raw_tweet):
        ...
        returns:
            a np boolean vector based on the contents and orientation of _word_features
    ...
    def classify(self, raw_tweet, consensus=5):
        ...
        Returns:
            A 'Unsure', 'Negative' or 'Positive' based on the votes of the algos and the consensus
        """
        # convert to vector
